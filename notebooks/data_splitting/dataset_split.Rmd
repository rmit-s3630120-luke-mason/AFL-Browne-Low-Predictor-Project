...
split <- function(df, name, seed = 3456) {
  ...
  write.csv(raw_stats[ trainIndex,], paste("../../data/train_", name, ".csv", sep=""), row.names=FALSE)
  write.csv(raw_stats[-trainIndex,], paste("../../data/test_", name, ".csv", sep=""), row.names=FALSE)
}
